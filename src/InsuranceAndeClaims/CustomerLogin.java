...
public class CustomerLogin extends JFrame {
	 ...
	 * Create the frame.
	 */
	public CustomerLogin(String something) {
		...
		lblNewLabel_1.setBounds(191, 41, 215, 14);
		...
		password.setBounds(226, 179, 230, 29);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	            ...
	            if (Password.equals(ob.password)) {
	            	...
	            	Customer ob1=new Customer(Email);
	            	ob1.setVisible(true);
	            	dispose();
				}
	            else {
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ForgetPassword obj=new ForgetPassword("customer");
				obj.setVisible(true);
				dispose();
			}
		});
		...
		button_3.setBounds(94, 11, 88, 23);
