...
public class NewPassword2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NewPassword2 frame = new NewPassword2("");
	 ...
	 * Create the frame.
	 */
	public NewPassword2(String email) {
		...
		lblNewPassword.setBounds(157, 11, 313, 26);
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (NPassword.equals(CPassword))
				{
					...
					ob.updatePasswordA(NPassword, email);
