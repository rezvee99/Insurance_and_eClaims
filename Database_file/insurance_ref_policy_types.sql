...
CREATE TABLE `ref_policy_types` (
  `Policy_Types_Code` int(11) NOT NULL,
  `Policy_Type_Description` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`Policy_Types_Code`)
...
INSERT INTO `ref_policy_types` VALUES (301,'All-risk policies'),(302,'Named perils policies.'),(303,'Replacement cost'),(304,'Actual cash value');
